...
export default function createVideo(mediaInfo, videoFile, { ffmpeg = 'ffmpeg' } = {}) {
	...
	const { width, height, pixels } = getFrame();
	...
	const proc = spawn(ffmpeg, [
		...
		'-pix_fmt', 'yuv420p',
		'-preset', 'slow',
		'-vf', 'crop=floor(iw/2)*2:floor(ih/2)*2', // needed for yuv420p format
		'-movflags', 'faststart',
		videoFile
